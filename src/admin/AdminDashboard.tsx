  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-zinc-500 text-xs mt-1">Select a section to edit its content.</p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
        {SECTION_KEYS.map((key, i) => (
          <button
            ...
            className="text-left border border-zinc-800 rounded bg-zinc-900 px-4 py-4 hover:border-zinc-600 hover:bg-zinc-800 transition-colors cursor-pointer group"
          >
