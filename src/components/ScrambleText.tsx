 ...
 *
 * Hero identity element — explicitly preserved (Thread 3 Hero Exception). This is
 * the intentional tech-scramble decode that signs the Hero; it is exempt from the
 * whole-unit typography rule applied elsewhere.
 */
